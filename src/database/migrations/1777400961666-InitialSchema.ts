...
export class InitialSchema1777400961666 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "service_token" ("id" SERIAL NOT NULL, "tokenHash" character varying NOT NULL, "schoolId" integer NOT NULL, "label" character varying NOT NULL, "lastUsedAt" TIMESTAMP WITH TIME ZONE, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_ac4ab6890f34bc9749c041d3983" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
